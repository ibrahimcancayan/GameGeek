...
const LoginScreen = ({}) => {
  ...
  const handleLogin = (values) => {
    validationSchema.validate(values).then(() => {
      navigation.navigate("CoffeScreen", values);
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.morningHeader}>
            <Text style={styles.starbucksText}>Game</Text>
          ...
          <View style={styles.promotionContainer}>
            ...
            >
              ...
              >
                <Text style={styles.promotionTitle}>Game News</Text>
                <View style={styles.promotionTextContainer}>
                  <Image
                    style={styles.promotionImage}
                    source={require("../../../assets/assets/images/banner.png")}
                  />
                </View>
                <Text style={styles.promotionCode}>Valorant new updates</Text>
              </View>
              <View
                style={[
                  styles.promotionBox,
                  { marginRight: width * 0.07, backgroundColor: "#FED985" },
                ]}
              >
                <Text style={[styles.promotionTitle,{color:"#000000"}]}>Game Geek</Text>
                <Text style={[styles.promotionDiscount,{color:"#000000"}]}>GTA V %10 OFF</Text>
                <View style={styles.promotionTextContainer}>
                  <Image
                    style={styles.promotionImage}
                    source={require("../../../assets/assets/images/gta.png")}
                  />
                </View>
